    ...
    public partial class AddOrgChartHierarchy : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                UPDATE AspNetUsers SET City = N'Brașov', Site = N'Siemens Digital Industry Software' WHERE Id IN ('11111111-0000-0000-0000-000000000014', '11111111-0000-0000-0000-000000000017', '11111111-0000-0000-0000-000000000020', '11111111-0000-0000-0000-000000000023', '11111111-0000-0000-0000-000000000026', '11111111-0000-0000-0000-000000000060', '11111111-0000-0000-0000-000000000061', '11111111-0000-0000-0000-000000000062', '11111111-0000-0000-0000-000000000063', '11111111-0000-0000-0000-000000000064', '11111111-0000-0000-0000-000000000065');
                ...
                UPDATE [Departments] SET [AdminId] = '11111111-0000-0000-0000-000000000006' WHERE [Id] IN ('22222222-0000-0000-0000-000000000001', '22222222-0000-0000-0000-000000000002');
                UPDATE [Departments] SET [AdminId] = '11111111-0000-0000-0000-000000000007' WHERE [Id] IN ('22222222-0000-0000-0000-000000000003', '22222222-0000-0000-0000-000000000004');
                UPDATE [Departments] SET [AdminId] = '11111111-0000-0000-0000-000000000008' WHERE [Id] IN ('22222222-0000-0000-0000-000000000005', '22222222-0000-0000-0000-000000000006', '22222222-0000-0000-0000-000000000007');
            ");
        }
